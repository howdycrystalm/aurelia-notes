//this is just a simple class that provides an api we can call
//recomds we create a api, a server class or something thar like what we'd write to wrap up our own backend.
